...
func (r *Router) ServeHTTP(w http.ResponseWriter, req *http.Request) {
	...
	if cbErr == nil {
		...
		success := r.tryPrimary(w, req, startTime)
		if success {
			return
		}
	}
	...
	r.executeFallback(w, req, startTime, cbErr)
}
...
func (r *Router) tryPrimary(w http.ResponseWriter, req *http.Request, startTime time.Time) bool {
...
func (r *Router) executeFallback(w http.ResponseWriter, req *http.Request, startTime time.Time, cbErr error) {
